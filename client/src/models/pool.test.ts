...
// import { ApiTestingPool, mockApi } from "../api/mock_api";
// import { SecondaryClients } from "./testPool";
//
...
//       __class: "User",
//     };
//     pool.syncResolver.applyServerUpdate({
//       type: "update",
//       jsonObject: staleUpdate,
//     });
//     expect(getUser().name).toEqual("Paul");
//
//     const serverUpdate = {
...
//     const p2 = SecondaryClients.getInstance(mockApi);
